...
const ENDOWMENT_DATA: CalibrationPoint[] = [
  // Age 19 dataset
...
const ANTICIPATED_DATA: CalibrationPoint[] = [
...
const CHILDREN_DATA: CalibrationPoint[] = [
...
const CONVERTIBLE_DATA: CalibrationPoint[] = [
...
const WHOLE_LIFE_DATA: CalibrationPoint[] = [
  { age: 19, duration: 16, premium: 395 },
  { age: 19, duration: 21, premium: 289 },
  { age: 19, duration: 26, premium: 228 },
  { age: 19, duration: 31, premium: 182 },
...
const JOINT_LIFE_DATA: CalibrationPoint[] = [
...
export const CALIBRATION_DATASET: Record<string, CalibrationPoint[]> = {
  // Canonical Keys
  SURAKSHA: WHOLE_LIFE_DATA,
  SANTOSH: ENDOWMENT_DATA,
  SUVIDHA: CONVERTIBLE_DATA,
  SUMANGAL: ANTICIPATED_DATA,
  YUGAL_SURAKSHA: JOINT_LIFE_DATA,
  BAL_JEEVAN_BIMA: CHILDREN_DATA,

  // Legacy Keys
  ENDOWMENT: ENDOWMENT_DATA,
  ANTICIPATED_ENDOWMENT: ANTICIPATED_DATA,
  CHILDREN: CHILDREN_DATA,
  CONVERTIBLE_WHOLE_LIFE: CONVERTIBLE_DATA,
  WHOLE_LIFE: WHOLE_LIFE_DATA,
  JOINT_LIFE: JOINT_LIFE_DATA,
};
