    ...
    <section className="relative bg-radial-[at_top_right] from-[#961b2d] via-[#751121] to-[#0f172a] text-white py-12 lg:py-0 lg:min-h-[calc(100svh-4.5rem)] flex items-center overflow-hidden border-b border-red-900/40">
      ...
      <div className="container-custom relative z-10 w-full py-4 lg:py-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          {/* Left Content Column with Sequenced Motion Stagger */}
          <motion.div
            variants={staggerContainer}
            initial="hidden"
            animate="visible"
            className="lg:col-span-7 text-center lg:text-left space-y-4 lg:space-y-4.5">
            {/* Official Logos & Sovereign Trust Badge */}
            <motion.div variants={fadeUpVariant} className="flex flex-wrap items-center justify-center lg:justify-start gap-2.5">
            ...
            {/* Headline */}
            <motion.h1 variants={fadeUpVariant} className="text-3xl sm:text-4xl md:text-5xl lg:text-[2.65rem] xl:text-[3rem] font-black tracking-tight leading-[1.12] text-white drop-shadow-sm">
            ...
            {/* Subheadline */}
            <motion.p variants={fadeUpVariant} className="text-xs sm:text-sm md:text-base text-slate-200 font-normal leading-relaxed max-w-xl mx-auto lg:mx-0">
            ...
            {/* Feature Value Pills */}
            <motion.div variants={fadeUpVariant} className="flex flex-wrap gap-2 justify-center lg:justify-start">
            ...
            {/* CTA Action Buttons */}
            <motion.div variants={fadeUpVariant} className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start pt-1">
              <MagneticButton>
                <Link
                  href="/calculator"
                  className="bg-linear-to-r from-amber-400 via-amber-300 to-yellow-400 text-slate-950 py-3 px-6 rounded-xl font-extrabold text-sm hover:from-amber-300 hover:to-yellow-300 hover:shadow-[0_0_25px_rgba(251,191,36,0.35)] active:scale-98 transition-all flex items-center justify-center gap-2 shadow-lg">
              ...
              <button
                ...
                className="bg-white/10 backdrop-blur-xl border border-white/20 text-white py-3 px-6 rounded-xl font-bold text-sm hover:bg-white/20 hover:border-white/35 active:scale-98 transition-all flex items-center justify-center gap-2 cursor-pointer">
                <i className="ri-layout-grid-fill text-sm text-amber-300"></i>
                <span>Explore 12 Plans</span>
              </button>
            </motion.div>

            {/* Verified Key Statistics Bar with Animated Counters */}
            <motion.div variants={fadeUpVariant} className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-3 border-t border-white/15 text-center lg:text-left">
              <div className="p-2 bg-white/5 backdrop-blur-md rounded-lg border border-white/10">
                <p className="text-xl font-black text-amber-300">
                  <AnimatedCounter value={76} prefix="₹" suffix="/₹1k" />
                </p>
              ...
              <div className="p-2 bg-white/5 backdrop-blur-md rounded-lg border border-white/10">
                <p className="text-xl font-black text-emerald-300">
                  <AnimatedCounter value={0} suffix="% GST" />
                </p>
                <p className="text-[0.62rem] text-slate-300 uppercase tracking-wider font-semibold">
                  Tax Savings
                </p>
              ...
              <div className="p-2 bg-white/5 backdrop-blur-md rounded-lg border border-white/10">
                <p className="text-xl font-black text-white">
                  <AnimatedCounter value={50} prefix="₹" suffix=" Lakhs" />
                </p>
                <p className="text-[0.62rem] text-slate-300 uppercase tracking-wider font-semibold">
                  Max Cover
                </p>
