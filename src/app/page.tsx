                ...
                <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-100">
                  <div>
                    <span className="text-xs font-black uppercase tracking-wider text-red-700 flex items-center gap-1">
                      <i className="ri-flashlight-fill text-amber-500 text-xs"></i> Live Quotation
                      Estimator
                    </span>
                    ...
                    >
                      {previewScheme === 'PLI' ? (
                        ...
                        <>
                          ...
                          <option value="GRAM_SURAKSHA">
                            Gram Suraksha — RPLI Whole Life (WLA)
                          </option>
                          <option value="GRAM_SUVIDHA">
                            Gram Suvidha — RPLI Convertible (CWLA)
                          </option>
                          <option value="GRAM_PRIYA">Gram Priya — 10-Year Money Back</option>
                          <option value="GRAM_SUMANGAL">
                            Gram Sumangal — RPLI Anticipated (AEA)
                          </option>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setPreviewSumAssured(parseInt(e.target.value, 10) || 500000)
                        }
                        className="w-full p-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-bold text-slate-800 outline-none focus:border-red-600 focus:bg-white"
                      />
                    </div>
      ...
      <section className="py-20 px-6 bg-white" id="why">
        <div className="container-custom">
          ...
          <p className="text-center text-slate-600 max-w-2xl mx-auto mb-16 text-sm md:text-base">
            Discover why millions of government officers, defense personnel, and rural citizens
            trust PLI & RPLI for life cover and long-term wealth creation.
          </p>
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-slate-700 text-xs leading-relaxed">
                  ...
                  <strong className="text-slate-900 font-bold">
                    &ldquo;All Graduates/Diploma holders from recognized
                    Universities/Institutions&rdquo;
                  </strong>{' '}
            ...
            <div className="p-6 rounded-3xl bg-linear-to-br from-emerald-500/10 via-blue-500/10 to-emerald-900/5 border border-emerald-900/20 shadow-sm space-y-2 flex flex-col justify-between">
              <div className="space-y-1.5">
                ...
                <p className="text-slate-700 text-xs leading-relaxed">
                  ...
                  with Post Office Savings Bank (POSB) or any Scheduled Bank in India is eligible
                  for RPLI.
                </p>
              </div>
              <Link
            ...
            <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-200">
              <div>
                <h3 className="text-2xl font-bold text-emerald-950 flex items-center gap-2">
                  <i className="ri-plant-line text-emerald-600"></i> Rural Postal Life Insurance
                  (RPLI)
                </h3>
                <p className="text-xs text-slate-500 mt-1">
      ...
      <section className="py-24 px-6 bg-(--primary-red) text-white text-center" id="contact">
        <div className="container-custom max-w-4xl">
          ...
          <p className="text-lg md:text-xl opacity-90 mb-10 leading-relaxed font-light">
            Join millions of satisfied policyholders who trust Postal Life Insurance and Rural
            Postal Life Insurance for guaranteed security, highest returns, and zero GST premiums.
          </p>
