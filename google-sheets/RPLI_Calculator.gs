...
function RPLI_QUOTE(dob, policyStartDate, plan, sumAssured, maturityAge, premiumMode, ageProofType, isRuralResident) {
  ...
  if (!matchedRow) {
    ...
    if ((entryAge === 40 || entryAge === 39) && (matAge === 60 || term === 20 || term === 21) && planCode.includes("SANTOSH")) {
      // Gram Santosh 39/60 (Term 21: 3.95/11.70/23.15/45.35) or 40/60 (Term 20: 4.20/12.45/24.65/48.35)
      matchedRow = ["ENDOWMENT", "Gram Santosh", entryAge, 60, term, (entryAge === 40 ? 4.20 : 3.95), (entryAge === 40 ? 12.45 : 11.70), (entryAge === 40 ? 24.65 : 23.15), (entryAge === 40 ? 48.35 : 45.35), 48.00, "2017-01-01", "9999-12-31", "India Post RPLI Endowment Table", "DoP/RPLI/EA/2020"];
